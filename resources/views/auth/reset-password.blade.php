...
<head>
    ...
    <title>Atur Ulang Password — NeoManga</title>
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white/[.04] backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
            <div class="flex items-center gap-3 mb-1">
                <h1 class="font-display text-2xl font-bold">Buat password baru</h1>
                <span class="flex items-center justify-center w-9 h-9 rounded-xl bg-brand/15 text-brand border border-brand/20">
                    <i class="fa-solid fa-lock-open"></i>
                </span>
            </div>
            <p class="text-sm text-slate-400 mb-6">Password baru minimal 8 karakter ya 🔒</p>
            ...
            <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                ...
                {{-- Token reset dari URL (wajib, kalau placeholder reset gagal) --}}
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="{{ $request->email ?? old('email') }}" required autocomplete="username"
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-slate-300 mb-1.5"><i class="fa-solid fa-lock w-5 text-brand"></i>Password baru</label>
                    <div class="relative">
                        ...
                        <input id="password" type="password" name="password" required autocomplete="new-password"
                               ...
                               placeholder="••••••••">
                        <button type="button" onclick="togglePass('password','eyeIcon1')" class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-300 transition-colors">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-slate-300 mb-1.5"><i class="fa-solid fa-shield-halved w-5 text-brand"></i>Konfirmasi password</label>
                    <div class="relative">
