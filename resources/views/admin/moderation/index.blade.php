    ...
    <div class="mx-card mt-4 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="mx-table" id="comments-table"
                   ...
                   data-bulk-actions='{{ json_encode([["value"=>"delete","label"=>"🗑 Hapus"],["value"=>"delete_ban","label"=>"🚫 Hapus & Ban User"]]) }}'>
                <thead>
                    <tr>
                        <th>Pengguna</th>
                        <th>Komentar</th>
    ...
    <div class="mx-card mt-4 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="mx-table" id="users-table"
                   ...
                   data-bulk-actions='{{ json_encode([["value"=>"ban","label"=>"🚫 Ban"],["value"=>"unban","label"=>"🔓 Unban"]]) }}'>
                <thead>
                    <tr>
                        <th>Pengguna</th>
                        <th>Role</th>
